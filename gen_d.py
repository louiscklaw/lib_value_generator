...
INPUT_TABLE='d_value_list.csv'
LIB_FILE_PATH='/home/logic/_workspace/kicad/kicad_library/kicad-symbols/taobao-d.lib'
...
COMPONENT_F_TEXT=Template("""F0 "D" -50 80 50 H V L CNN
F1 "$component_name" -150 -80 50 H V L CNN
F2 "$DEFAULT_SD_FOOTPRINT" 0 0 50 V I C CNN
F3 "" 0 0 50 V I C CNN""")
...
$$CMP $component_name
D $SD_DESCRIPTION, diode, small symbol, 二极管 ,
K $SD_KEYWORD diode
F ~
$$ENDCMP
""")
    ...
    with open(INPUT_TABLE,'r') as f:
        ...
        for test_line in raw_lines:
            try:
                ...
                raw_values.append(('D_'+zd_name,zd_name, zd_footprint, zd_description, zd_keyword))
            except Exception as e:
                pprint(test_line)
                raise e
                pass

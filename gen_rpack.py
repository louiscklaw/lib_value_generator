...
LIB_FILE_PATH='/home/logic/_workspace/kicad/kicad_library/kicad-symbols/taobao-rpack.lib'
...
# $R_THREE_DIGIT_VALUE
#
DEF $R_THREE_DIGIT_VALUE RN 0 0 Y N 1 F N
F0 "RN" -300 0 50 V V C CNN
F1 "$R_THREE_DIGIT_VALUE" 200 0 50 V V C CNN
F2 "$d_footprint" 275 0 50 V I C CNN
F3 "" 0 0 50 H I C CNN
$$FPLIST
...
#
DEF $R_THREE_DIGIT_VALUE_SIZE RN 0 0 Y N 1 F N
F0 "RN" -300 0 50 V V C CNN
F1 "$R_THREE_DIGIT_VALUE_SIZE" 200 0 50 V V C CNN
F2 "$d_footprint" 275 0 50 V I C CNN
F3 "" 0 0 50 H I C CNN
$$FPLIST
$R_SIZE
...
K R network parallel topology isolated $R_THREE_DIGIT_VALUE_SIZE $R_TEXT_VALUE
F ~
$$ENDCMP
""")
...
D 4 resistor network, parallel topology, DIP package
K R network parallel topology isolated $R_THREE_DIGIT_VALUE $R_TEXT_VALUE
F ~
$$ENDCMP
""")
...
fp_default_fp_matcher={
    ...
    '0603': 'Resistor_SMD:R_Array_Concave_4x0603',
...
def getLibFile(r_settings):
    ...
    # int_r_value='6.2'
    # r_three_digit_code = 'RN_'+getThreeDigitCode(int_r_value)
    ...
    for r_name, l_r_size in r_settings:
        try:
            ...
            R_r_name = 'RN_'+getThreeDigitCode(int_r_value)
...
def main():
    with open('rpack_value_list.csv','r') as f:
        ...
        # print(R_LIB_UNIT_TEMPLATE.substitute(R_VALUE='RN_'+three_digit_code), end='')
